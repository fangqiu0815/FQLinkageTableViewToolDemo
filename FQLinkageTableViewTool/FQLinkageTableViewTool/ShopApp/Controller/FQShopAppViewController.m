...
#import "FQCollectionViewFlowLayout.h"
...
@implementation FQShopAppViewController
{
...
- (NSMutableArray *)dataSource
{
    if (!_dataSource)
    {
        _dataSource = [NSMutableArray arrayWithArray:@[@"热门分类",@"个性配饰",@"温暖家居",@"热门分类",@"个性配饰",@"温暖家居",@"热门分类",@"个性配饰",@"温暖家居",@"热门分类",@"个性配饰",@"温暖家居"]];
    }
    return _dataSource;
}
...
- (UITableView *)tableView
{
    if (!_tableView)
    {
        ...
        [_tableView registerClass:[LeftTableViewCell class] forCellReuseIdentifier:@"LeftTableViewCell"];
    }
    return _tableView;
}

- (FQCollectionViewFlowLayout *)flowLayout
{
    if (!_flowLayout)
    {
        _flowLayout = [[FQCollectionViewFlowLayout alloc] init];
