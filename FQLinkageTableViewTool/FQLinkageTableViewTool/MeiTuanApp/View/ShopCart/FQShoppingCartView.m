...
@interface FQShoppingCartView()<UITableViewDelegate,UITableViewDataSource>
{
    CGRect BOUNDS;
    CGFloat Height_Cell;
...
@implementation FQShoppingCartView
...
- (FQCartHeader *)header{
    if (!_header) {
        _header = [[FQCartHeader alloc]init];
...
- (FQCartFooter *)footer{
    if (!_footer) {
        _footer = [[FQCartFooter alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"FQCartFooter"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    FQCartGoodsCell * cell = [tableView dequeueReusableCellWithIdentifier:@"FQCartGoodsCell"];
    if (cell==nil) {
        cell = [[FQCartGoodsCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"FQCartGoodsCell"] ;
    }
    FQCartGoodsCell *goods = [self.goodsList.shoppingCart.bags.firstObject goodsArr][indexPath.row];
