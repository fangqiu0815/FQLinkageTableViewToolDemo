...
@implementation MTShopCountStepper
...
- (void)setStyle:(FQCountStepperStyle)style{
    _style = style;
    [_subBtn setImage:[UIImage imageNamed:style==FQCountStepperStyleGoodsList?@"shoplist_stepper_sub_icon":@"shoplist_stepper_subred_icon"] forState:UIControlStateNormal];
    [_addBtn setImage:[UIImage imageNamed:style==FQCountStepperStyleGoodsList?@"shoplist_stepper_add_icon":@"shoplist_stepper_addred_icon"] forState:UIControlStateNormal];
}
